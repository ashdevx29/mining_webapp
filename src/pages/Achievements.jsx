...
//         <div style={{ fontSize: 22, fontWeight: 900 }}>🏅 Achievements</div>
...
//           border: '1px solid rgba(245,158,11,0.2)', borderRadius: 20, padding: '20px',
//         }}>
...
//                 {earnedCount}/{total}
//               </div>
//               <div style={{ fontSize: 11, color: '#6b7280' }}>Unlocked</div>
//             </div>
//             <div style={{ width: 1, background: 'rgba(255,255,255,0.06)' }} />
//             <div style={{ textAlign: 'center' }}>
//               <div style={{ fontSize: 26, fontWeight: 900, color: '#a78bfa' }}>
//                 {totalXP}
//               </div>
...
//                 style={{
//                   background: isEarned ? `${ach.color}12` : '#1a1a2e',
//                   border: `1px solid ${isEarned ? `${ach.color}40` : 'rgba(255,255,255,0.06)'}`,
...
//                   }}>✅</div>
//                 )}
//                 <div style={{ fontSize: 36, marginBottom: 8 }}>{ach.icon}</div>
//                 <div style={{ fontSize: 12, fontWeight: 800, marginBottom: 4, color: isEarned ? '#fff' : '#6b7280' }}>
//                   {ach.title}
//                 </div>
...
//                   color: isEarned ? ach.color : '#4b5563',
//                 }}>
//                   {isEarned ? '⭐' : '🔒'} {ach.xp} XP
//                 </div>
//               </motion.div>

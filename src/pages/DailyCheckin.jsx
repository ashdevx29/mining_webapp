...
//         <div style={{ fontSize: 22, fontWeight: 900 }}>🔥 Daily Check-in</div>
...
//           <div>
//             <div style={{ fontSize: 24, fontWeight: 900, color: '#fbbf24' }}>{streak} Day Streak</div>
//             <div style={{ fontSize: 11, color: '#9ca3af' }}>Keep it going!</div>
//           </div>
//         </motion.div>
//       </div>
...
//                 style={{
//                   background: isPast ? 'rgba(16,185,129,0.12)' : isToday ? 'rgba(245,158,11,0.15)' : '#1a1a2e',
//                   border: `1px solid ${isPast ? 'rgba(16,185,129,0.4)' : isToday ? 'rgba(245,158,11,0.5)' : 'rgba(255,255,255,0.06)'}`,
...
//                   <div style={{
//                     position: 'absolute', top: -6, right: -4,
//                     background: '#f43f5e', borderRadius: 99, fontSize: 9,
//                     fontWeight: 800, padding: '2px 5px', color: '#fff', letterSpacing: 0.3,
//                   }}>★</div>
//                 )}
//                 {isPast ? (
//                   <div style={{ fontSize: 22, color: '#10b981' }}>✅</div>
//                 ) : (
//                   <div style={{ fontSize: 20 }}>{isToday ? '🎁' : '🔒'}</div>
//                 )}
//                 <div style={{ fontSize: 11, color: '#6b7280', marginTop: 4, fontWeight: 600 }}>Day {d.day}</div>
//                 <div style={{
//                   fontSize: 12, fontWeight: 800, marginTop: 2,
//                   color: isPast ? '#6ee7b7' : isToday ? '#fbbf24' : '#4b5563',
//                 }}>
//                   {formatNumber(d.reward)}
//                 </div>
//               </motion.div>
...
//         }}>
//           <div style={{ color: '#9ca3af', fontSize: 13, marginBottom: 8 }}>Today's Reward</div>
//           <div style={{
...
//             +{formatNumber(DAYS[Math.min(streak, DAYS.length - 1)].reward)} MINE
//           </div>
//           <div style={{ color: '#6b7280', fontSize: 12, marginTop: 4 }}>Day {streak + 1} reward</div>
//         </div>
//       </div>
...
//               animate={{ opacity: 1, scale: 1 }}
//               exit={{ opacity: 0 }}
//               style={{ textAlign: 'center', padding: 20, fontSize: 48 }}
//             >
//               🎉
//             </motion.div>
//           )}
...
//             <span style={{ color: '#6ee7b7', fontWeight: 700, fontSize: 15 }}>Already claimed today!</span>
//           </div>
//         ) : (
//           <motion.button
//             whileTap={{ scale: 0.97 }}
...
//             <div style={{ flex: 1 }}>
//               <div style={{ fontSize: 13, fontWeight: 600 }}>{b.benefit}</div>
//               <div style={{ fontSize: 11, color: '#6b7280' }}>At {b.streak} day streak</div>
//             </div>
//             {streak >= b.streak ? (
//               <span style={{ color: '#10b981', fontSize: 14 }}>✅</span>
//             ) : (
//               <span style={{ color: '#4b5563', fontSize: 11, fontWeight: 700 }}>{b.streak}d</span>
//             )}
//           </div>
//         ))}
//       </div>

...
{/* <div className="absolute top-[420px] left-0 right-0 flex flex-col items-center z-20">
...
<div className="absolute bottom-[210px] left-0 right-0 px-10 z-20">
...
>
  ...
  {/* <div
    className="mt-5 text-center text-yellow-300 text-3xl tracking-[8px]"
    style={{ fontFamily: "'Orbitron', sans-serif" }}
  >
    100%
  </div> */}
...
//       const stepIdx = Math.floor((current / 100) * steps.length);
//       setStatusText(steps[Math.min(stepIdx, steps.length - 1)]);
//     }, 250);
//     return () => clearInterval(interval);
//   }, [onDone]);
...
//       alignItems: 'center', justifyContent: 'center', zIndex: 9998, padding: 40,
//     }}>
//       <motion.div
...
//         {/* Status */}
//         <div style={{ color: '#6b7280', fontSize: 13, marginBottom: 32, minHeight: 20 }}>
//           {statusText}
//         </div>
...
//         <div style={{ color: '#f59e0b', fontSize: 13, fontWeight: 700 }}>{progress}%</div>
//       </motion.div>
//     </div>
//   );
// }
